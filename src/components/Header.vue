...
<template>
  <header class="navbar" :class="`text-bg-${theme}`">
    ...
    <div class="ms-auto">
        <svg @click="goToFavorites" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="me-3 bi bi-heart" viewBox="0 0 16 16">
